...
#RawDataPath = '~/flexo/AdvancedOpticalMicroscopy/SpinningDisk/RawData/2018_08_03_NPmEOS3.2'
#ProcessedPath = '~/flexo/AdvancedOpticalMicroscopy/SpinningDisk/Processed/2018_08_03_NPmEOS3.2'
RawDataPath = '//flexo/MicroscopyData/AdvancedOpticalMicroscopy/SpinningDisk/RawData/2018_08_03_NPmEOS3.2'
ProcessedPath = '//flexo/MicroscopyData/AdvancedOpticalMicroscopy/SpinningDisk/Processed/2018_08_03_NPmEOS3.2'

ImgDir = 'Timeseries'
SmDir = 'Hope_2'
BgDir = 'BG_2018_0803_1228_1'
...
ImgBgPath = os.path.join(RawDataPath, BgDir) # Background image folder path, of form 'BG_yyyy_mmdd_hhmm_X'          
outputChann = ['Transmission', 'Retardance', 'Orientation', 'Retardance+Orientation',
               'Transmission+Retardance+Orientation']# channels to output, see readme for channel names
