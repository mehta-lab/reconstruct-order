...
def get_position_map(zarr_dir, zarr_name):
    ...
    """
    position_map = {}
    for c, col in enumerate(os.listdir(zarr_dir + zarr_name + '/Row_0')):
        if col.startswith('.'):
            continue
...
if __name__ == '__main__':
    ...
    output_path = r'/hpc/projects/comp_micro/projects/HEK/2022_03_15_orgs_nuc_mem_63x_04NA_test/'  # save directory
    ...
    pos_ids = list(range(10))  # choose positions
    n_workers = 10
