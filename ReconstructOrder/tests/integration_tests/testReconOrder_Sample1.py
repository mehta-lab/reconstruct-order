...
class TestImageReconstruction(unittest.TestCase):
    ...
    targetData = '/reconData/2018_10_02_MouseBrainSlice/'
    ...
    source_config_file = '/config_MouseBrainSlice1_workflow_test.yml'
    ...
    def __init__(self, *args, **kwargs):
        ...
        print("SOURCE CONFIG FILE = "+self.source_config_file)
    ...
    def construct_all(self):
        ...
        img_stokes_sm = img_reconstructor.stokes_normalization(img_stokes_sm)
